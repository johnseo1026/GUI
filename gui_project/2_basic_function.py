...
def add_file():
    ...
    initialdir=r"C:\Users\Owner\Desktop\git\python_game\pygame_project\images") # 최초에 C:/ 경로를 보여줌
...
def start():
    ...
    if len(txt_dest_path.get()) == 0:
        msgbox.showwarning("경고", "저장 경로 선택하세요")
        return
